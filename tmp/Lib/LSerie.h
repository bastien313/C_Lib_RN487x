...
public:
	...
	//------ OPEN AND CONFIGURE ------
	bool open(string comPort, long speedInBaud);	//Open the serial port COM "numPort" at the speed "speedInBaud".
	...
	void getErrorMsg(char* chaine);			// Return: The error message generated by the last function.
